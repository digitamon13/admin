...
//https://back-endn.onrender.llcom
...
export const checkIfAdminIsLoggedIn = () => {
  return async (dispatch, getState) => {
    try {
      ...
      response = await fetch(`https://front-end-ys8q.onrender.com/adminbytoken`, {
        method: "GET",
        headers:{
...
export const loginAdmin = (data) => {
  ...
  return async (dispatch, getState) => {
    try {
      let response = await fetch('https://front-end-ys8q.onrender.com/adminlogin', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const signupAdmin = (data) => {
  ...
  return async (dispatch, getState) => {
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/adminsignup`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const fetchUsers = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch('https://front-end-ys8q.onrender.com/users', {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteUser = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/users/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchHistory = (user)=>{
  ...
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/history/${user}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateHistory = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/history/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchLoan = (user)=>{
  ...
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/loan/${user}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateLoan = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/loan/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchAccounts = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/admin-accounts/${id}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateAccount = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/admin-accounts`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const createAccount = (data,user)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/admin-accounts/${user}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchCard = (user)=>{
  ...
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/card/${user}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateCard = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/card/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateAdmin = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/admin/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const credit = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/credit`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const debit = (data,user)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/debit`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const sendEmail = (data,id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://front-end-ys8q.onrender.com/sendemail`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
